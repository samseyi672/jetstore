                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img src="" alt="" class="img-fluid img-90 rounded-circle blur-up lazyloaded profileimg">
                                    <h5 class="f-w-600 mb-0" id="profilename">John deo</h5>
                                   <!--  one  can the email later  -->
                                   <!--  
                                   <span>johndeo@gmail.com</span>
                                    -->
                                   <!--  add the  social media later -->
                                   <!--  <div class="social">
                               ...
                               <!--  to here  -->
                                <hr>
                                  <!--  this will  be  used  by admin dont  forget for employees performance -->
                        ...
                        <div class="card tab2-card">
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="top-tabContent">
                                    ...
                                    <!-- to here  -->
                                  <!--   team will tell me what  to do  concerning this  place  -->
