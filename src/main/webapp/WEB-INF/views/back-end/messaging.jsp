                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="page-header-left">
                                        <h3>
                                            Messages <small>Crista Digital Admin</small>
                                        </h3>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <ol class="breadcrumb pull-right">
                                        ...
                                        <li class="breadcrumb-item">Physical/Digital</li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="col-md-7">
                                            <form>
                                                <div class="form-group">
                                                    <select class="userandvendor form-control" multiple="multiple" name="userandvendor[]"
                                                            id="userandvendor">
                                                    </select>
                                                </div>
                                            </form>
    ...
    <input class="form-control col-xl-8 col-sm-7" name="search">  
     <div id="match-list" style="z-index:4;position:absolute;"></div>                                          
                                                   ...
                                                   <small><i style="color: blue"><strong>*separate by comma if one than one</strong></i></small>
                                                    ...
                                                    <div class="form">
                                                      ...
                                                      <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-sm-4">Search By* :</label>
                                                            <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                                                                <div class="form-group">
                                                                    <div
                                                                        class="m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated">
                                                                        <label class="d-block" for="edo-ani"> <input
                                                                                ...
                                                                                name="selectype" value="vendor"> Vendor
                                                                        </label> 
                                                                        <!-- 	<label class="d-block" for="edo-ani1"> <input
                                                                        ...
                                                                        <label
                                                                            class="d-block" for="edo-ani1"> <input
                                                                                ...
                                                                                name="selectype" value="users" checked> Users
                                                                        </label> 
                                                                        <label class="d-block" for="edo-ani1"> | </label> 							    	
                                                                        <label class="d-block" for="edo-ani1"> <input
                                                                                class="radio_animated" id="edo-ani14" type="radio"
                                                                                name="selectype" value="allusers"
                                                                                onclick="messagechoice(this)"
                                                                                > All Users
                                                                        </label> 
                                                                        <!-- 	
                                                                        <label class="d-block" for="edo-ani1"> | </label> 
                                                                        <label class="d-block" for="edo-ani1"> <input
                                                                                ...
                                                                                name="selectype" value="allvendors"
                                                                                onclick="messagechoice(this)" >
                                                                                All Vendors
                                                                        </label>
                                                                        -->																	 
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-xl-3 col-sm-4">Type Message*
                                                                :</label>
                                                            <div class="col-xl-8 col-sm-7 pl-0 description-sm">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="mt-1 page-content page-container justify-content-center" id="page-content">
    <div class="padding">
        <div class="row container d-flex justify-content-left">
          <div class="col-md-6">
            <div class="card card-bordered">
              <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="overflow-y: scroll !important; height:200px !important;">
                <div class="media media-chat">
                  <ui class="media-body" id="messagearea">
<!--                   <li>HI</li>-->
                  </ui>
                </div>
            ...
            <form id="messageForm" name="messageForm" nameForm="messageForm">
				<div class="form-group">
					<div class="input-group clearfix">
						<input type="text" id="chatmsg" placeholder="Type a message here ..."
							autocomplete="off" class="form-control" />
                                                &nbsp;
						<button type="submit" class="btn btn-primary chat_message" id="sendbtn">Send</button>
					</div>
				</div>
			</form>
              </div>
