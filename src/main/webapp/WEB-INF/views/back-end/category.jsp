...
<!--     <div class="page-main-header">
        <div class="main-header-right row">
            <div class="main-header-left d-lg-none">
                <div class="logo-wrapper"><a href="index.html"><img src="/assets/images/dashboard/crista.png" alt=""></a></div>
            </div>
                            ...
                            <li>
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <p class="mb-0">Get download please.</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <h3>Category
                                    <small>Crista Admin panel</small>
                                </h3>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="btn-popup pull-right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-original-title="test" data-target="#exampleModal" id="savecategory">Add Category</button>
                                   <!--  dialog box -->
                                  <%--   <jsp:include page="dialog.jsp" /> --%>
                                </div>
                                
                              <!--       table disabled.its pops up here  -->
                                <div class="table-responsive">
                                    <div id="basicScenario2" class="product-physical">
                                           
                                    </div>
                                </div> 
                         <jsp:include page="excel.jsp" />  
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">Copyright <script>document.write(new Date().getFullYear())</script> © Crista All rights reserved.</p>
                    </div>
                    <div class="col-md-6">
    <p class="pull-right mb-0">Developed by JetSoft (A subsidiary of Jetlink)<i class="fa fa-heart"></i></p>
                    </div>
                </div>
            </div>
        </footer> -->
