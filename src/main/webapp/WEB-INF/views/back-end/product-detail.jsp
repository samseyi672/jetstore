...
<html lang="en">
<head>
<jsp:include page="productdetailsheader.jsp" />
</head>
<body>
...
<li><a class="sidebar-header" href="invoice.html"><i data-feather="archive"></i><span>Invoice</span></a>
 ...
 -->        <!-- Page Sidebar Ends-->
        ...
        <div class="page-body">
			...
			<form>
				<div class="form-group">
					<select class="prdsearch form-control" name="prdsearch"
						id="prdsearch">
					</select>
				</div>
			</form>
                    ...
                    <div class="row product-page-main card-body">
                       <!--  <div class="col-xl-4">
                            <div class="product-slider owl-carousel owl-theme" id="sync1">
                                <div class="item">
                                <img src="/assets/images/pro3/2.jpg"  id="prdimage" alt="" 
                                class="blur-up lazyloaded"></div>                 
                            </div>
                        </div> -->
                         <div class="col-xl-4">                                                 
                                <img width="300px" height="300px" src="/assets/images/pro3/2.jpg"  id="prdimage" alt="" 
                                class="blur-up lazyloaded">                                                                  
                        </div>
                        <div class="col-xl-8" id="prddetails" style="display:none">
                            <div class="product-page-details product-right mb-0">
                                ...
                                <p id="prddes">product description goes here</p>
                                ...
                                <div class="add-product-form">
                                    ...
                                    <fieldset class="qty-box mt-2 ml-0">
                                        <div class="input-group">
                                            <input class="touchspin" type="text" id="qty" value="1">
                                        </div>
                                    </fieldset>                                 
                                </div><br/>
                                 <p id="prdstatus">dddd</p>
                            <!--        <p id="prdcode">dddd</p>
                                    <p id="prdmodel">sssaa</p> -->
                                     <p id="prdsummary">sssaa</p>
                                  <!--     <p id="prdmodel">sssaa</p> -->
                                <hr>
                              <!--   <h6 class="product-title">Time Reminder</h6>
                                ...
                                <div class="m-t-15">
                                    ...
                                    <!--
                                    (incase customer is buying from the backend if possible)
                                    -->
...
<!-- latest jquery-->
  <jsp:include page="productdetailsfooter.jsp"/>
</body>
</html>
