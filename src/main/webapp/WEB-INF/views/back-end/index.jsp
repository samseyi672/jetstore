...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description"
                content="Crista admin">
        <meta name="keywords"
                content="admin">
        <meta name="author" content="pixelstrap">
        <link rel="icon" href="/assets/images/dashboard/crista.png"
                type="image/x-icon">
        <link rel="shortcut icon" href="/assets/images/dashboard/crista.png"
                type="image/x-icon">
        ...
        <div class="nav-right col">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                    <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="/assets/images/dashboard/login-bg.png" alt="header-user">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="page-header-left">
                                        <h3 data-localize="index.panel">
                                            Dashboard 								
                                        </h3>							
                                    </div>
                                    <small data-localize="digital2">Crista Digital Admin panel</small>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <ol class="breadcrumb pull-right">
                                        <li class="breadcrumb-item"><a href="/adminindex"><i
                                                    data-feather="home"></i></a></li>
                                        <li class="breadcrumb-item active" data-localize="index.panel2">Dashboard</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="bg-warning card-body">
                                        <div class="media static-top-widget row">
                                            ...
                                            <div class="media-body col-8">
                                                <span class="m-0" data-localize="index.earnings">Earnings</span>
                                                <h3 class="mb-0">
                                                    $ <span class="counter">9925</span><small data-localize="index.thismonth"> This
                                                        Month</small>
                                                </h3>
                                            </div>
                                        </div>
                                ...
                                <div class="card o-hidden  widget-cards">
                                    <div class="bg-secondary card-body">
                                        <div class="media static-top-widget row">
                                            ...
                                            <div class="media-body col-8">
                                                <span class="m-0" data-localize="index.products">Products</span>
                                                <h3 class="mb-0">
                                                    $ <span class="counter">11023</span><small data-localize="index.thismonth"> This
                                                        Month</small>
                                                </h3>
                                            </div>
                                        </div>
                                ...
                                <div class="card o-hidden widget-cards">
                                    <div class="bg-primary card-body">
                                        <div class="media static-top-widget row">
                                            ...
                                            <div class="media-body col-8">
                                                <span class="m-0" data-localize="index.message">Messages</span>
                                                <h3 class="mb-0">
                                                    $ <span class="counter">893</span><small data-localize="index.thismonth"> This Month</small>
                                                </h3>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card o-hidden widget-cards">
                                    <div class="bg-danger card-body">
                                        <div class="media static-top-widget row">
                                            ...
                                            <div class="media-body col-8">
                                                <span class="m-0" data-localize="index.vendor">New Vendors</span>
                                                <h3 class="mb-0">
                                                    $ <span class="counter">45631</span><small data-localize="index.thismonth"> This
                                                        Month</small>
                                                </h3>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-6 xl-100">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 data-localize="index.market">Market Value</h5>
...
&lt;!-- Cod Box Copy end --&gt;</code>
                            ...
                            <div class="col-xl-6 xl-100">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 data-localize="index.order">Latest Orders</h5>
                                        <div class="card-header-right">
                                            <ul class="list-unstyled card-option">
                                                <li><i class="icofont icofont-simple-left"></i></li>
                                                <li><i class="view-html fa fa-code"></i></li>
                                    ...
                                    <div class="card-body">
                                        <div class="user-status table-responsive latest-order-table">
                                            <table class="table table-bordernone">
                                                <thead>
                                                    <tr>
                                                        <th scope="col" data-localize="index.orderid">Order ID</th>
                                                        <th scope="col" data-localize="index.ordertotal">Order Total</th>
                                                        <th scope="col"  data-localize="index.orderpay">Payment Method</th>
                                                        <th scope="col" data-localize="index.orderstatus">Status</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                            ...
                                            <a target="_" href="./order" class="btn btn-primary" data-localize="index.viewall">View All
                                                Orders</a>
                                        </div>
                                        <div class="code-box-copy">
                                            <button class="code-box-copy__btn btn-clipboard"
...
&lt;/div&gt;
                            ...
                            <div class="col-xl-3 col-md-6 xl-50">
                                <div class="card order-graph sales-carousel">
                                    <div class="card-header">
                                        <h6 data-localize="index.totalsales">Total Sales</h6>
                                        <div class="row">
                                            <div class="col-6">
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <span data-localize="index.lastmonth">Sales Last Month</span>
                            ...
                            <div class="col-xl-3 col-md-6 xl-50">
                                <div class="card order-graph sales-carousel">
                                    <div class="card-header">
                                        <h6 data-localize="index.purchase">Total purchase</h6>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="small-chartjs">
                                                    <div class="flot-chart-placeholder"
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <span data-localize="index.monthpurchase">Monthly purchase</span>
                                                <h2 class="mb-0">2154</h2>
                                                <p>
                                                    0.13% <span><i class="fa fa-angle-up"></i></span>
                                                </p>
                                                <h5 class="f-w-600" data-localize="index.avg">Avg Gross purchase</h5>
                                                <p>Lorem Ipsum is simply dummy text of the printing and
                                                    typesetting</p>
                                            </div>
                            ...
                            <!--						<div class="col-xl-3 col-md-6 xl-50">
                                                                                    <div class="card order-graph sales-carousel">
                                                                                            <div class="card-header">
                                                                                                    <h6 data-localize="index.cash">Total cash transaction</h6>
                                                                                                    <div class="row">
                                                                                                            <div class="col-6">
                                                                                                                    <div class="small-chartjs">
                                                                                                                            <div class="flot-chart-placeholder"
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                    <div class="media">
                                                                                                            <div class="media-body">
                                                                                                                    <span data-localize="index.cashonhand">Cash on hand</span>
                                                                                                                    <h2 class="mb-0">4672</h2>
                                                                                                                    <p>
                                                                                                                            0.8% <span><i class="fa fa-angle-up"></i></span>
                                                                                                                    </p>
                                                                                                                    <h5 class="f-w-600" data-localize="index.details">Details about cash</h5>
                                                                                                                    <p>Lorem Ipsum is simply dummy text of the printing and
                                                                                                                            typesetting</p>
                                                                                                            </div>
                            ...
                            <!--						<div class="col-xl-3 col-md-6 xl-50">
                                                                                    <div class="card order-graph sales-carousel">
                                                                                            <div class="card-header">
                                                                                                    <h6 data-localize="index.deposits">Daily Deposits</h6>
                                                                                                    <div class="row">
                                                                                                            <div class="col-6">
                                                                                                                    <div class="small-chartjs">
                                                                                                                            <div class="flot-chart-placeholder"
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                    <div class="media">
                                                                                                            <div class="media-body">
                                                                                                                    <span data-localize="index.security">Security Deposits</span>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 data-localize="index.buysell">Buy / Sell</h5>
                                        <div class="card-header-right">
                                            <ul class="list-unstyled card-option">
                                                <li><i class="icofont icofont-simple-left"></i></li>
                                                <li><i class="view-html fa fa-code"></i></li>
...
&lt;/div&gt;</code>
                            ...
                            <!--						<div class="col-xl-6 xl-100">
                                                                                    <div class="card height-equal">
                                                                                            <div class="card-header">
                                                                                                    <h5 data-localize="goodsreturn">Goods return</h5>
                                                                                                    <div class="card-header-right">
                                                                                                            <ul class="list-unstyled card-option">
                                                                                                                    <li><i class="icofont icofont-simple-left"></i></li>
                                                                                                                    <li><i class="view-html fa fa-code"></i></li>
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                    <div class="user-status table-responsive products-table">
                                                                                                            <table class="table table-bordernone mb-0">
                                                                                                                    <thead>
                                                                                                                            <tr>
                                                                                                                                    <th scope="col" data-localize="index.detail">Details</th>
                                                                                                                                    <th scope="col"  data-localize="index.qty">Quantity</th>
                                                                                                                                    <th scope="col" data-localize="index.statu">Status</th>
                                                                                                                                    <th scope="col" data-localize="index.p">Price</th>
                                                                                                                            </tr>
                                                                                                                    </thead>
                                                                                                                    <tbody>
                                                                                                                            <tr>
                            ...
                            &lt;/div&gt;
                                                                            ...
                                                                            <div class="col-xl-6 xl-100">
                                                                                    <div class="card height-equal">
                                                                                            <div class="card-header">
                                                                                                    <h5 data-localize="index.emp">Employee Status</h5>
                                                                                                    <div class="card-header-right">
                                                                                                            <ul class="list-unstyled card-option">
                                                                                                                    <li><i class="icofont icofont-simple-left"></i></li>
                                                                                                                    <li><i class="view-html fa fa-code"></i></li>
                            ...
                            &lt;div class="user-status table-responsive products-table"&gt;
                                &lt;table class="table table-bordernone mb-0"&gt;
                                    &lt;thead&gt;
                                        &lt;tr&gt;
                                            &lt;th scope="col" data-localize="index.name"&gt;Name&lt;/th&gt;
                                            &lt;th scope="col" data-localize="index.des"&gt;Designation&lt;/th&gt;
                                            &lt;th scope="col" data-localize="index.skill"&gt;Skill Level&lt;/th&gt;
                                            &lt;th scope="col" data-localize="index.exp"&gt;Experience&lt;/th&gt;
                                        &lt;/tr&gt;
                                    &lt;/thead&gt;
                                    &lt;tbody&gt;
                                            &lt;tr&gt;
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 data-localize="index.salesstatus">Sales Status</h5>
                                        <div class="card-header-right">
                                            <ul class="list-unstyled card-option">
                                                <li><i class="icofont icofont-simple-left"></i></li>
                                                <li><i class="view-html fa fa-code"></i></li>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-sm-6 xl-50">
                                                <div class="order-graph">
                                                    <h6 data-localize="index.orderbylocation">Orders By Location</h6>
                                            ...
                                            <div class="col-xl-3 col-sm-6 xl-50">
                                                <div class="order-graph sm-order-space">
                                                    <h6 data-localize="salebylocation">Sales By Location</h6>
                                            ...
                                            <div class="col-xl-6 xl-100">
                                                <div class="order-graph xl-space">
                                                    <h6 data-localize="monthrevenue">Revenue for last month</h6>
   ...
   &lt;div class="col-xl-3 col-sm-6 xl-50"&gt;
      &lt;div class="order-graph sm-order-space"&gt;
         &lt;h6 data-localize="index.salebylocation"&gt;Sales By Location&lt;/h6&gt;
         &lt;div class="peity-chart-dashboard text-center"&gt;
            &lt;span class="pie-colours-1"&gt;4,7,6,5&lt;/span&gt;
         &lt;/div&gt;
         &lt;div class="order-graph-bottom sales-location"&gt;
   ...
   &lt;div class="col-xl-6 xl-100"&gt;
      &lt;div class="order-graph xl-space"&gt;
         &lt;h6 data-localize="index.monthrevenue"&gt;Revenue for last month&lt;/h6&gt;
         &lt;div class="ct-4 flot-chart-container"&gt;&lt;/div&gt;
      &lt;/div&gt;
   &lt;/div&gt;
&lt;/div&gt;</code>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright 2021 © Jetsoft All rights reserved.</p>
            </div>
            <div class="col-md-6">
