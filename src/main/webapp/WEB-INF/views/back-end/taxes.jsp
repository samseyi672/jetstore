                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Add/Set Taxes' Detail</h5>
                            </div>
                            <div class="card-body">
                                <div id="basicScenario2" class="product-list translation-list">
...
<script src="/assets/js/jsgrid/griddata-taxes.js"></script>
<script src="/assets/js/jsgrid/jsgrid-taxes.js"></script>
