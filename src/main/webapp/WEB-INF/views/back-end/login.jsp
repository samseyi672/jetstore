...
<!--     <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <jsp:include page="loginpageslink.jsp" />
</head>
<body>
<!-- page-wrapper Start-->
	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                        ...
                        <div class="single-item">
                            <div>
                                <div>
                                    <h3>Welcome to Crista Digital</h3>
                                    <p>Crista Digital is your one spot marketplace for your shopping for all your needs.</p>
                                </div>
                            </div>
                            <div>
                                <div>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" name="top_profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" id="submitLogin">
                                ...
                                <div class="tab-pane fade" id="top-contact" role="tabpanel" aria-labelledby="contact-top-tab">
                                    <form class="form-horizontal auth-form" id="contactform">
                                        <div class="form-group">
                                            <input required="" name="email" type="email" class="form-control" placeholder="Username" id="username">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="password" id="password" type="password" class="form-control" placeholder="Password">
                                        </div>
                                        <div class="form-group">
                                            <input required="" name="confirmPassword" id="confirmPassword" type="password" class="form-control" placeholder="Confirm Password">
                                        </div>                                       
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
            ...
            <a href="/adminindex" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>back</a>
        </div>
    </div>
</div>
...
$('#login').click(e=>{
    e.preventDefault();
     $.ajax({
       url:'http://localhost:1022/authenticate',
       type: "POST",
       dataType: 'json',
       ...
       error:function(err,xhqr){
            console.log(err,' and ',xhqr) ;
       }
      });
})
</script> -->
