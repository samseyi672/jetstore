       ...
       <!--  <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                <div class="sidebar-user text-center">
                    ...
                    <h6 class="mt-3 f-14">Your name</h6>
                    <p>Role.</p>
                </div>
                <ul class="sidebar-menu">
                    <li><a class="sidebar-header" href="adminindex"><i data-feather="home"></i><span>Dashboard</span></a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="digital-add needs-validation">
                                    ...
                                    <div class="form-group">
                                        <label for="validationCustom01" class="col-form-label pt-0"><span>*</span> Title (product Name)</label>
                                            ...
                                            <div class="form-group row">
                                                    ...
                                                    <fieldset class="qty-box col-xl-9 col-xl-8 col-sm-7 pl-0">                        
                                                        <div class="input-group">
                                                            <input class="touchspin" type="text" name="productquantity" value="1">                    
                                                        </div>                                
                                                    </fieldset>
                                                </div>
                                      <div class="form-group">
                                        <label for="validationCustomtitle" class="col-form-label pt-0"><span>*</span>Product Code</label>
                                        <input class="form-control" type="text" required="" name="productcode">
                                    </div>
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <select class="custom-select" required="" name="subcategoryid">
                                            <option value="">--Select--</option>
                                            <option value="1">eBooks</option>
                                            <option value="2">Graphic Design</option>
                                            <option value="3">3D Impact</option>
                                    ...
                                    <div class="form-group">
                                        <label class="col-form-label">Short Summary</label>
                                        <textarea rows="5" cols="12" name="shortsummary"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label"><span>*</span> Product Price</label>
                                        <input class="form-control" id="validationCustom02" type="text" required="" name="productprice">
                                    </div>
                                    <div class="form-group">
                                        <label for="validationCustom02" class="col-form-label"><span>*</span>Expiry Date</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated">
                                            <label class="d-block" for="edo-ani">
                                                <input class="radio_animated" id="edo-ani" type="radio" name="state">
                                                Enable
                                            </label>
                                            <label class="d-block" for="edo-ani1">
                                                <input class="radio_animated" id="edo-ani1" type="radio" name="state">
                                                Disable
                                            </label>
                                            <label class="d-block" for="edo-ani1">
                                                  |
                                             ...
                                             <label class="d-block" for="edo-ani1">
                                                <input class="radio_animated" id="edo-ani13" type="radio" name="productstatus">
                                                New
                                            </label>
                                             <label class="d-block" for="edo-ani1">
                                                <input class="radio_animated" id="edo-ani14" type="radio" name="productstatus">
                                                Old
                                            </label>
                                        </div>
                                    </div>
                                   ...
                                   <!--  <form class="dropzone digits" id="singleFileUpload" action="/upload.php">
                                     ...
                                     <div class="form-group">
                                       <!--  <label for="validationCustom02" class="col-form-label"><span>*</span>Product Upload</label> -->
                                        <input class="form-control col-xl-8 col-sm-7" name="imageurl" id="validationCustom04" type="file" required="">
                                    </div>
                                ...
                                <div class="digital-add needs-validation">
                                    <div class="form-group mb-0">
                                        <div class="description-sm">
                                            <textarea id="editor1" name="proddescription" cols="10" rows="4"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="digital-add needs-validation">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="validationCustom05" name="metatitle" type="text" required="">
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label">Meta Description</label>
                                        <textarea rows="4" cols="12" name="metadescription"></textarea>
                                    </div>
                                    <div class="form-group mb-0">
                                        <div class="product-buttons text-center">
                                            <button type="button" class="btn btn-primary" id="adddigitalprod">Add</button>
