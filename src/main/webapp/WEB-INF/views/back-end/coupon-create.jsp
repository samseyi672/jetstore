...
<li><a class="sidebar-header" href="invoice.html"><i data-feather="archive"></i><span>Invoice</span></a>
 ...
 -->        <!-- Page Sidebar Ends-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <ol class="breadcrumb pull-right">
                                <li class="breadcrumb-item"><a href="/adminindex"><i data-feather="home"></i></a></li>
            ...
            <div class="container-fluid">
                <div class="card tab2-card">
                    <div class="card-header">
                        <h5 style="cursor:pointer;" onclick="(()=>{$('#formbody').slideToggle();})()">Add Discount Coupon</h5>
                    </div>
                    <div class="card-body" style="display:none;" id="formbody">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                                <form class="needs-validation" novalidate="" id="general2">
                                    <h4>General</h4>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span> Coupan Title</label>
                                                <input class="form-control col-md-7" id="validationCustom0" type="text" required="" name="coupontitle">
                                            </div>
                                            <div class="form-group row">
                                                <label for="validationCustom1" class="col-xl-3 col-md-4"><span></span>Coupan Code</label>
                                                <input class="form-control col-md-7" id="validationCustom1" type="text" name="couponcode" >
                                                <label for="validationCustom1" class="col-xl-8 col-md-9"><span>if left blank, it will be generated</span></label>
                                               <!--  <div class="valid-feedback">Please Provide a Valid Coupon Code.</div> -->
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-md-4">Start Date</label>
                                                <input class="datepicker-here form-control digits col-md-7" type="date" data-language="en" name="startdate">
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-md-4">End Date</label>
                                                <input class="datepicker-here form-control digits col-md-7" type="date" data-language="en" name="enddate">
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-md-4">Free Shipping</label>
                                                <div class="checkbox checkbox-primary col-md-7">
                                                    <input id="checkbox-primary-1" type="checkbox" data-original-title="" title="" name="freeshipping">
                                                    <label for="checkbox-primary-1">Allow Free Shipping</label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-md-4">Quantity</label>
                                                <input class="form-control col-md-7" type="number" required="" name="couponqty" />
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-xl-3 col-md-4">Discount Type</label>
                                                <select class="custom-select col-md-7" required="" name="discounttype">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="checkbox checkbox-primary col-md-7">
                                                    <input id="checkbox-primary-2" type="checkbox" data-original-title="" title="" name="couponstatus" />
                            ...
                            <div class="tab-pane fade" id="restriction" role="tabpanel" aria-labelledby="restriction-tabs">
                                <form class="needs-validation" novalidate="" id="rest">
                                    <h4>Restriction</h4>
                                    <div class="form-group row">
                                        <label for="validationCustom3" class="col-xl-3 col-md-4">Products</label>
                                       <!--  <input class="form-control col-md-7" id="validationCustom3" type="text" required=""  name="couponproduct"/> -->
                                        <select class="prodsearch form-control col-xl-5 col-md-9" name="prodsearch" id="prodsearch">
                                                  
                                                <select>
                                                <!-- <input type="hidden" type="text" id="prdid" name="prdid"/> -->
                                        <div class="valid-feedback">Please Provide a Product Name.</div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-xl-3 col-md-4">Category</label>
                                        <select class="custom-select col-md-7" required="" name="couponcategory" id="couponcategory">
                                            <option value="">--Select--</option>
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <select class="custom-select col-md-7" required="" name="couponsubcategory" id="couponsubcategory">
                                            <option value="">--Select--</option>
                                            <option value="1">Electronics</option>
                                            <option value="2">Clothes</option>
                                            <option value="2">Shoes</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input class="form-control col-md-7" id="validationCustom4" type="number" name="minspend" >
                                    </div>
                                    <div class="form-group row">
                                        <label for="validationCustom5" class="col-xl-3 col-md-4">Maximum Spend</label>
                                        <input class="form-control col-md-7" id="validationCustom5" type="number" name="maxspend" >
                                    </div>
                                </form>
                            </div>
                            <div class="tab-pane fade" id="usage" role="tabpanel" aria-labelledby="usage-tab">
                                <form class="needs-validation" novalidate="" id="usage2">
                                    <h4>Usage Limits</h4>
                                    <div class="form-group row">
                                        <label for="validationCustom6" class="col-xl-3 col-md-4">Per Limit</label>
                                        <input class="form-control col-md-7" id="validationCustom6" type="number"  name="perlimit" />
                                    </div>
                                    <div class="form-group row">
                                        <label for="validationCustom7" class="col-xl-3 col-md-4">Per Customer</label>
                                        <input class="form-control col-md-7" id="validationCustom7" type="number" name="percustomer" >
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="pull-right">
                            <button type="button" class="btn btn-primary" id="savecoupon">Save</button>
                              <button type="button" class="btn btn-cancel" onclick="function cancel(){document.getElementById('general2').reset(); document.getElementById('usage2').reset(); document.getElementById('rest').reset();} cancel()">Discard</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card tab2-card">
                    ...
                    <div class="card-body">
                         <div class="table-responsive">
                               <div id="basicScenario2" class="product-physical">
  ...
  <!-- coupon list Container-fluid starts-->
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">                                
                              <!--   <div class="table-responsive">
                               <div id="basicScenario2" class="product-physical">
                                 ...
                                 <div class="table-responsive" id="couponbody"> 
