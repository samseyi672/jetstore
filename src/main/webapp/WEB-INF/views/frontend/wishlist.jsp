   ...
   <jsp:include page="header.jsp" />
    ...
    <section class="wishlist-section section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <table class="table cart-table table-responsive-xs" id="wishlisttable">
                        <thead>
                            <tr class="table-head">
            ...
            <div class="row wishlist-buttons">
                <div class="col-12"><a href="/jetcart/marketplace" class="btn btn-solid">continue shopping</a> <a href="/jetcart/checkout"
