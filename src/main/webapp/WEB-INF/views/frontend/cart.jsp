...
<!--     
    ...
    <link rel="icon" href="/assets/images/faviconcrista.png" type="image/x-icon">
                                    ...
                                    <nav>
                                       ...
                                       <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                            ...
                                            <li><a href="category-page(healthy).html">Healthy Living Products</a></li>
                                             <li> <a href="category-page(accessories).html">Accessories</a>
                                                <ul>
                                                    <li><a href="cables.html">Cables</a></li>
...
<!--                    <table class="table cart-table table-responsive-xs">
                            ...
                            <tr>
                                ...
                                <a href="#">cotton shirt</a>
                                    <div class="mobile-cart-content row">
                                        ...
                                        <div class="col-xs-3">
                                            <h2 class="td-color">$63.00b</h2>
                                        </div>
                                        <div class="col-xs-3">
                                            <h2 class="td-color"><a href="#" class="icon"><i class="ti-close">
                                            </i></a>
                                            </h2>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <h2 class="td-color">$4539.00me</h2>
                                </td>
                            </tr>
                        </tbody>
                        <tbody>
            ...
            <div class="row cart-buttons">
                <div class="col-6"><a href="/jetcart/marketplace" class="btn btn-solid">continue shopping</a></div>
                <div class="col-6"><a href="/jetcart/checkout" class="btn btn-solid">check out</a></div>
            </div>
        </div>
    </section>
    <!--section end-->
