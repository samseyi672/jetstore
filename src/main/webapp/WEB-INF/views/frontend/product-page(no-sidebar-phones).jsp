        ...
        <div class="breadcrumb-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <nav aria-label="breadcrumb" class="theme-breadcrumb">Mobile Phones</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-slick">
                            <div><img src="../assets/images/bags/7.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-0"></div>
                            <div><img src="../assets/images/bags/9.jpg" alt=""
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            <h2 class="mb-0">Mobile Phones</h2>
            ...
            <div class="row search-product">
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="../assets/images/bags/7.jpg"
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="../assets/images/bags/9.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="../assets/images/bags/7.jpg"
