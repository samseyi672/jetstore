        ...
        <div class="breadcrumb-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <nav aria-label="breadcrumb" class="theme-breadcrumb">Phone Accessories</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-slick">
                            <div><img src="/assets/images/jewellery/pro/1.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-0"></div>
                            <div><img src="/assets/images/jewellery/pro/2.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-1"></div>
                            <div><img src="/assets/images/jewellery/pro/3.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-2"></div>
                            <div><img src="/assets/images/jewellery/pro/4.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-3"></div>
                        </div>
                        <div class="row">
                            <div class="col-12 p-0">
                                <div class="slider-nav">
                                    <div><img src="/assets/images/jewellery/pro/5.jpg" alt=""
                                            class="img-fluid blur-up lazyload"></div>
                                    <div><img src="/assets/images/jewellery/pro/6.jpg" alt=""
                                            class="img-fluid blur-up lazyload"></div>
                                    <div><img src="/assets/images/jewellery/pro/7.jpg" alt=""
                                            class="img-fluid blur-up lazyload"></div>
                                    <div><img src="/assets/images/jewellery/pro/8.jpg" alt=""
                                            class="img-fluid blur-up lazyload"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            <h2 class="mb-0">Phone Accessories</h2>
                          ...
                          <!-- 
                            ...
                            <div class="product-buttons"><a href="#" data-toggle="modal" data-target="#addtocart"
                                    class="btn btn-solid">add to cart</a> <a href="/jetcart/checkout" class="btn btn-solid">buy now</a>
                            </div> 
            ...
            <div class="row search-product">
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/jewellery/pro/9.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/jewellery/pro/10.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                        ...
                        <div class="product-detail">
                            ...
                            <a href="product-page(no-sidebar-phoneaccessories).html">
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/jewellery/pro/11.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/jewellery/pro/12"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/jewellery/pro/13.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/jewellery/pro/14.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/jewellery/pro/15.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/jewellery/pro/16.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/jewellery/pro/17.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/jewellery/pro/18.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/jewellery/pro/19.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(no-sidebar-phoneaccessories).html"><img src="/assets/images/jewellery/pro/20.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
