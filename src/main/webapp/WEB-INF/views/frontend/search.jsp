                ...
                <div class="container">
                    <div class="row align-items-center">
                       ...
                       <!--      <form class="form-header">
                                ...
                                <div class="row">                    
                                    <input type="text" class="form-control itemsearch" aria-label="Amount (to the nearest dollar)"
                            ...
                            <form class="form-inline">
								  <div class="form-group mx-sm-3 mb-2">
								    <select style="width:300px" type="text" class="form-control itemsearch" id="itemsearch">
								    </select>
								    <input size="30" type="hidden">
								  </div>
								  <button class="btn btn-solid mb-2"><i class="fa fa-search"></i>Search</button>
								</form>
                        </div>
                    </div>
                </div>
