...
<link rel="icon" href="/assets/images/favicon/crista.png"
	type="image/x-icon">
<link rel="shortcut icon" href="/assets/images/favicon/crista.png"
	type="image/x-icon">
                            ...
                            <div class="main-menu">
                                <div class="menu-left">
                                    ...
                                    <div class="brand-logo">
                                        <a href="index.html"><img src="/assets/images/icon/logo/crista_logo.png"
                                        ...
                                        <nav>
                                            ...
                                            <ul class="sm pixelstrap sm-horizontal">
                                              ...
                                              class="fa fa-angle-right pl-2" aria-hidden="true"></i></div>
                                                ...
                                                <li>
                                                    <a href="#">Computers,Phones & Appliances</a>
                                                </li>
                                                <li>
                                                    <a href="#">Appliances & Accessories</a>
                                                </li>                                               
                                                <li><a href="#">pages</a>
                                                </li>
                                                <li>
        ...
        <div class="layout-8-bg">
            ...
            <section class="section-b-space ratio_square">
                <div class="container-fluid">
                                    ...
                                    <div class="row no-slider">
                                            <div class="product-box">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#" onclick="loadprd(2,'/jetcart/productpage')"><img
                                                ...
                                                <div class="details-product">
                                                    <a href="/jetcart/productpage" onclick="loadprd(2,'/jetcart/productpage')">
                                                        <h6>Appliance3</h6>
                                                    </a>
                                            ...
                                            <div class="product-box">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="/jetcart/productpage" onclick="loadprd(3,'/jetcart/productpage')"><img
                                                ...
                                                <div class="details-product">
                                                    <a href="/jetcart/productpage" onclick="loadprd(3,'/jetcart/productpage')">
                                                        <h6>Appliance4</h6>
                                                    </a>
                                                    <h4>$500.00</h4>
                                                </div>
                                            ...
                                            <div class="product-box">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="/jetcart/productpage" onclick="loadprd(4,'/jetcart/productpage')"><img
                                                ...
                                                <div class="details-product">
                                                    <a href="/jetcart/productpage" onclick="loadprd(4,'/jetcart/productpage')">
                                                        <h6>Speaker</h6>
                                                    </a>
                                                    <h4>$500.00</h4>
                                                </div>
                                            ...
                                            <div class="product-box">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="/jetcart/productpage"><img
                    ...
                    <div class="container-fluid marketplace" id="marketplace">
...
<footer class="footer-light">
 ...
 -->    
 <!--footer section end add footer  here  -->  
