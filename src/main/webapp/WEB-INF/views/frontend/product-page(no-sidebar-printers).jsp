                                    ...
                                    <div>
                                        <nav>
                                            ...
                                            <ul class="sm pixelstrap sm-horizontal">
                                                ...
                                                <li>
                                                    <a href="#">Computers & Phones</a>
                                                </li>
                                                <li class="mega"><a href="#">Appliances & Accessories</a>
                                                </li>
                                                <li><a href="#">pages</a>
                                                </li>
                                                <li>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="page-title">
                            <h2>Scanners & Printers</h2>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <nav aria-label="breadcrumb" class="theme-breadcrumb">Scanners & Printers</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                                ...
                                                <ul class="show-div shopping-cart">
                                                    ...
                                                    <li>
                                                        <div class="buttons"><a href="cart.html" class="view-cart">view
                                                                cart</a> <a href="checkout.html" class="checkout">checkout</a></div>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Scanners & Printers</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-slick">
                            <div><img src="/assets/images/fashion/pro/1.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-0"></div>
                            <div><img src="/assets/images/fashion/pro/2.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-1"></div>
                            <div><img src="/assets/images/fashion/pro/3.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-2"></div>
                            <div><img src="/assets/images/fashion/pro/4.jpg" alt=""
                                    class="img-fluid blur-up lazyload image_zoom_cls-3"></div>
                        </div>
                        <div class="row">
                            <div class="col-12 p-0">
                                <div class="slider-nav">
                                    <div><img src="/assets/images/fashion/pro/5.jpg" alt=""
                                            class="img-fluid blur-up lazyload"></div>
                                    <div><img src="/assets/images/fashion/pro/6.jpg" alt=""
                                            class="img-fluid blur-up lazyload"></div>
                                    <div><img src="/assets/images/fashion/pro/7jpg" alt=""
                                            class="img-fluid blur-up lazyload"></div>
                                    <div><img src="/assets/images/fashion/pro/8.jpg" alt=""
                                            class="img-fluid blur-up lazyload"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            <h2 class="mb-0">Scanners & Printers</h2>
                   ...
                   <!--          <div class="product-buttons"><a href="#" data-toggle="modal" data-target="#addtocart"
                                    class="btn btn-solid">add to cart</a> <a href="checkout.html" class="btn btn-solid">buy now</a>
                            </div> -->
            ...
            <div class="row search-product">
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/fashion/pro/9.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/fashion/pro/10.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="back">
                                <a href="#"><img src="/assets/images/fashion/pro/12.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/fashion/pro/13.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/fashion/pro/14.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/fashion/pro/15.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/fashion/pro/16.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                        ...
                        <div class="product-detail">
                            <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i
                                    class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div>
                            <a href="product-page(no-sidebar-appliances).html">
                                <h6>Scanners & Printers</h6>
                            </a>
                            <h4>$500.00</h4>
                            <ul class="color-variant">
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/fashion/pro/17.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/fashion/pro/18.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
                ...
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="#"><img src="/assets/images/fashion/pro/19.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="#"><img src="/assets/images/fashion/pro/20.jpg"
                                        class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button data-toggle="modal" data-target="#addtocart" title="Add to cart"><i
