                        ...
                        <div class="main-menu">
                            <div class="menu-left">
                                ...
                                <div class="brand-logo">
                                    <a href="index.html"><img src="/assets/images/icon/crista.png"
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header-contact">
                            <ul>
                                <li>Welcome to CRISTA DIGITAL</li>
                                <li><i class="fa fa-phone" aria-hidden="true"></i>Call Us: 0808575038</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 text-right">
										...
										<ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="/assets/images/mega-menu/laptops.jpg"
                                            ...
                                            <li> <a href="#">Phones</a>
                                                <ul>
                                                    ...
                                                    <li><a href="featurephones.html">Feature Phones</a></li>
                                                </ul>
                                            </li>
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a target="_blank" href="healthy.html">Healthy Living Products</a></li>                                              
                                        ...
                                        <li>
                                            <a href="#">shop</a>
                                            <ul>
                                                <li><a href="category-page(computers).html">Computers</a></li>
                                                <li><a href="category-page(phones).html">Phones</a></li>
                                                <li><a href="category-page(appliances).html">Appliances</a></li>
                                                <li><a href="category-page(healthy).html">Healthy Living Products</a></li>
                                                <li><a href="category-page(accessories).html">Accessories <span
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="#">Computers</a>
                                                    <ul>
                                                        <li><a href="product-page(laptops).html">Laptops</a></li>
                                                        <li><a href="product-page(desktops).html">Desktops</a></li>
                                                        <li><a href="product-page(notebooks).html">Notebooks</a></li>
														<li><a href="product-page(servers).html">Servers</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <a href="#">Phones</a>
                                                    <ul>
                                                        <li><a href="product-page(smartphones).html">Smart Phones</a></li>
                                                        <li><a href="product-page(featurephones).html">Feature Phones</a>
                                                        </li>
                                                        <li><a href="product-page(phones-watches).html">Smart Phones & Watches
                                                ...
                                                <li>
                                                    <a href="#">Appliances</a>
                                                    <ul>
                                                        <li><a href="product-page(bakeware).html">Bake Ware</a></li>
                                                        <li><a href="product-page(blenders).html">Blenders</a></li>
                                                        <li><a href="product-page(burners).html">Burners</a></li>
														<li><a href="product-page(cookers).html">Cookers</a></li>
                                                        <li><a href="product-page(dining).html">Dining</a></li>
                                                        <li><a href="product-page(dispensers).html">Water Dispensers</a></li>
														<li><a href="product-page(freezers).html">Freezers</a></li>
                                                        <li><a href="product-page(irons).html">Irons</a></li>
                                                        <li><a href="product-page(washers).html">Washers</a></li>
														<li><a href="product-page(fans).html">Fans</a></li>
                                                        <li><a href="product-page(refrigerators).html">Refrigerators</a></li>
                                                        <li><a href="product-page(airconditioners).html">Air Conditioners</a></li>
														<li><a href="product-page(kettles).html">Kettles</a></li>
                                                        <li><a href="product-page(microwaves).html">Microwaves</a></li>
														<li><a href="product-page(mincers).html">Mincers</a></li>
                                                        <li><a href="product-page(pounders).html">Pounders</a></li>
                                                        <li><a href="product-page(toasters).html">Toasters</a></li>
														<li><a href="product-page(utensils).html">Utensils</a></li>
                                                        <li><a href="product-page(vaccum).html">Vaccum Cleaners</a></li>
                                                        <li><a href="product-page(ventilators).html">Ventilators</a></li>
                                                    </ul>
                                                </li>
												<li>
                                                    <a href="#">Accessories</a>
                                                    <ul>
                                                        <li><a href="product-page(bakeware).html">printers</a></li>
                                                        <li><a href="product-page(blenders).html">Scanners</a></li>
                                                        <li><a href="product-page(burners).html">Inks,Toners & Cartridges</a></li>
														<li><a href="product-page(cookers).html">Cables</a></li>
                                                        <li><a href="product-page(dining).html">Cases & Covers</a></li>
                                                        <li><a href="product-page(dispensers).html">Screen Protectors</a></li>
														<li><a href="product-page(freezers).html">Chargers & Power Banks</a></li>
                                                        <li><a href="product-page(earphones-headsets).html">Earphones & Headsets</a></li>
                                                        <li><a href="product-page(Smartwatches).html">Smartwatches & Bands</a></li>
														<li><a href="product-page(batteries).html">Batteries</a></li>
                                                        <li><a href="product-page(peripherals).html">Computer Peripherals</a></li>
                                                        <li><a href="product-page(bccs).html">Bags,Cases,Covers & Sleeves</a></li>
														<li><a href="product-page(dlaccessories).html">Desktops and Laptops Accessories</a></li>
                                                        <li><a href="product-page(storage).html">Storage Devices</a></li>
														<li><a href="product-page(cases).html">Cases & Covers</a></li>
                                                        <li><a href="product-page(holders).html">Holders & Stands</a></li>
                                                        <li><a href="product-page(other-accessories).html">Other Accessories</a></li>
														
                                                    </ul>
                                                </li>
                                                <li><a href="product-page(healthy).html">Healthy Living Products<span
                                                            class="new-tag">new</span></a></li>
                                                <li><a href="product-page(networking).html">Networking</a></li>
                                                                ...
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            ...
                                                                            <li><a href="ledtvs.html">LED TVs</a></li>
                                                                            ...
                                                                            <li><a href="hifisystems.html">HiFi Systems</a></li>
                                                                            <li><a href="audiosystems.html">Audio Systems</a></li>
                                                                            <li><a href="mp3player.html">MP3 Players  &  Speakers</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <li>
                                            <a href="#">blog</a>
                                            <ul>
                                                <li><a href="blog-page.html">IT Trends</a></li>
                                                <li><a href="blog(right-sidebar).html">Computers</a></li>
                                                <li><a href="blog(no-sidebar).html">Appliances</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-3 collection-filter">
                        ...
                        <div class="collection-filter-block" id="itemselection">
                            <!-- brand filter start -->
                            ...
                            <div class="collection-collapse-block open">
                                ...
                                <div class="collection-collapse-block-content">
                                    <div class="collection-brand-filter">
                                        ...
                                        <div class="custom-control custom-checkbox collection-filter-checkbox">
                                            <input type="checkbox" class="custom-control-input" value="vera-moda" id="vera-moda">
                                            <label class="custom-control-label" for="vera-moda">vera-moda</label>
                                        </div>
                                        <div class="custom-control custom-checkbox collection-filter-checkbox">
                                            <input type="checkbox" class="custom-control-input" value="forever-21" id="forever-21">
                                            <label class="custom-control-label" for="forever-21">forever-21</label>
                                        </div>
                                        <div class="custom-control custom-checkbox collection-filter-checkbox">
                                            <input type="checkbox" class="custom-control-input" value="roadster" id="roadster">
                                            <label class="custom-control-label" for="roadster">roadster</label>
                                        </div>
                                        <div class="custom-control custom-checkbox collection-filter-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="only" value="only">
                                ...
                                <div class="collection-collapse-block-content">
                                    <div class="color-selector">
                                        <ul>
                                            ...
                                            <li class="color-4 purple" data-purple="purple"></li>
                                            <li class="color-5 blue" data-blue="blue"></li>
                                            <li class="color-6 yellow" data-yellow="yellow"></li>
                                            <li class="color-7 green" data-green="green"></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
