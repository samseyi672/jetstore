...
public class PageNavigationProcessingController {
	...
	//private final String  jwtTokenURL  = "https://jeteshop.herokuapp.com/authenticate";
	private final String customerJwtTokenURL ="http://localhost:1022/authenticatecustomer" ;
	//private final String customerJwtTokenURL  = "https://jeteshop.herokuapp.com/authenticatecustomer";
	   //@PostMapping("/login")
